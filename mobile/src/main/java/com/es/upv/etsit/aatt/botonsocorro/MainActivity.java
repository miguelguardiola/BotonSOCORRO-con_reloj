...
public class MainActivity extends AppCompatActivity implements MessageApi.MessageListener, GoogleApiClient.ConnectionCallbacks {
    ...
    String latitud = "No_encontrada";
    String longitud = "No_encontrada";
    private GoogleApiClient apiClient;
    private TextView textView;
    private static final String WEAR_ARRANCAR_ACTIVIDAD = "/mandar_texto";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ////////////////////ESTA PARTE ES LA DE LA CONEXION ////////////////////////////////////////
...
// CONFIGURAMOS EL BOTON DE CONFIGURACIÓN
    ...
    public void sos() {
       ...
       if(ActivityCompat.checkSelfPermission(
            ...
            enviarMensaje(telefono,nombre+ " ha pulsado SOS en: " + latitud ); // Hay una función auxiliar que manda el sms.
        }
